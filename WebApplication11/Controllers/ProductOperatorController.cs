...
namespace WebApplication11.Controllers
{
    ...
    public class ProductOperatorController : Controller
    {
        ...
        public ProductOperatorController(IProductAdminViewModel productAdminRepository, IWebHostEnvironment webHostEnvironment,DatabaseContext context, UserManager<IdentityUser> userManager, ILogger<IdentityUser> logger)
        {
            _context = context;
