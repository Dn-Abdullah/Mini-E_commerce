...
namespace WebApplication11.Controllers
{
...

    {
        ...
        public ProductUserController(DatabaseContext context, IWebHostEnvironment hostEnvironment, IProductUserViewModel productUserRepository, IHttpContextAccessor httpContextAccessor)
        {
            _context = context;
